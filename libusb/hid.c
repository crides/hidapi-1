...
static int get_hid_item_size(uint8_t *report_descriptor, unsigned int pos, uint32_t size, int *data_len, int *key_size)
{
...
static int get_next_hid_usage(uint8_t *report_descriptor, uint32_t size, unsigned int *pos, unsigned short *usage_page, unsigned short *usage)
{
							...
							between interfaces. */
								...
								if (res >= 0) {
									...
									if (res >= 0) {
                                        ...
                                        uint32_t pos = 0;
                                        get_next_hid_usage(data, res, &pos, &page, &usage);
